...
pragma solidity ^0.8.7;
contract PSCICOAndReward is Ownable {
  ...
  constructor(address _currency) {
    ...
    startSale(block.number, block.number + 864000, 40000, 70000000);
    startAirdrop(block.number, block.number + 864000 * 3, 10, 1265000);
  }
